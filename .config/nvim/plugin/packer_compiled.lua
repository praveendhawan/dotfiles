...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-treesitter-context", "vim-matchup", "nvim-treesitter-refactor", "playground" },
  ...
  ["tokyonight.nvim"] = {
    after = { "twilight.nvim", "zen-mode.nvim" },
    loaded = true,
    only_config = true
  },
  ["twilight.nvim"] = {
  ...
  ["vim-tmux-navigator"] = {
    loaded = true,
    path = "/home/praveen/.local/share/nvim/site/pack/packer/start/vim-tmux-navigator",
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'vim-gutentags', 'vim-trailing-whitespace', 'ale', 'vim-test', 'splitjoin.vim'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
