...
vim.api.nvim_set_keymap('n', '<leader>hnn', '', { callback = require('harpoon.ui').nav_next, desc = 'Goto Next Mark' })
vim.api.nvim_set_keymap('n', '<leader>hpp', '', { callback = require('harpoon.ui').nav_prev, desc = 'Goto Previous Mark' })
