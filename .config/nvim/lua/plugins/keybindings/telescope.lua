...
vim.api.nvim_set_keymap('n', '<leader>af', '<cmd>lua require("telescope.builtin").current_buffer_fuzzy_find()<cr>', noremap_silent_opt)
vim.api.nvim_set_keymap('n', '<leader>g', '<cmd>lua require("telescope.builtin").live_grep()<cr>', noremap_silent_opt)
...
vim.api.nvim_set_keymap('n', '<C-f>', '<cmd>lua require("telescope.builtin").grep_string()<cr>', noremap_silent_opt)
